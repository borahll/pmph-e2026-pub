...
"Programming Massively Parallel Hardware", 2026-2027, which warrants
...
* please report the runtimes of all four code versions for the large
  dataset and try to briefly explain them, i.e., can you explain the
  performance differences across these 4 versions, at a high level,
  in terms of work-depth complexity?
